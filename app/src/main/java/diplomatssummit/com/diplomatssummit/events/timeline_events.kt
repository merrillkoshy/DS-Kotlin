 ...
 *
 */
class timeline_events : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.timeline_events, container, false)
        val mWebView: WebView = view.findViewById(R.id.webviewtime)
        val url="https://diplomatssummit.com/mobile/timeline_events.php"
